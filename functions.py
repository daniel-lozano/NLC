...
KB = 1#0.086173  # Boltzmann constant [meV/K]
...
def Hamiltonian(basis,N,Jzz,Jpm,Jppmm,Jzpm,B_field,NN,ST):
...
def specific_heat(eigenvals,eigenvect,Temp):
    ...
    c_h=((average_2/Z)-(average/Z)**2)/(KB*Temp**2)##*6.022E23 * 1.602E-22

    
    return c_h

def Energy(eigenvals,eigenvect,Temp):
